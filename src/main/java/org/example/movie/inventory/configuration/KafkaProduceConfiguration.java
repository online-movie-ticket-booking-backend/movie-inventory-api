...
public class KafkaProduceConfiguration {
    ...
    @Bean
    public ProducerFactory<String, MovieInventoryResponse> producerFactoryMovieInventoryResponse() {
        return new DefaultKafkaProducerFactory<>(getConfigurationMap());
    }

    @Bean
    public ProducerFactory<String, MovieDetailsListRequest> producerFactoryMovieDetailsListRequest() {
        return new DefaultKafkaProducerFactory<>(getConfigurationMap());
    }
